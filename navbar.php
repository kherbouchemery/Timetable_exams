<nav class="navbar navbar-default">
  <div class="container-fluid" style="background-color:#5bb68f;">
    ...
    <div >
      <ul class="nav navbar-nav" >
        ...
        <li><a href="add.faculty.php"><span class="glyphicon glyphicon-list-alt"></span> Add Faculty</a></li>
		...
		<li><a href="add.classroom.php"><span class="glyphicon glyphicon-home"></span> Add Classroom</a></li>
